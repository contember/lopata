					...
					<td key={col} class="px-4 py-2">
						<div class="flex items-center gap-1">
							<input
								...
								class={`w-full bg-panel border border-border rounded px-2 py-1 font-mono text-xs outline-none focus:border-ink focus:ring-1 focus:ring-border ${
									isNullVal ? 'opacity-40' : ''
								}`}
							/>
							<button
