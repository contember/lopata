import type { BrowserHistoryEntry, HistoryEntry } from './types'
							...
							<div class="flex flex-wrap gap-x-3 gap-y-0.5">
								{filterStr && (
									<span class="text-xs text-text-secondary">
										<span class="text-text-muted">filter:</span> <span class="font-mono">{filterStr}</span>
									</span>
								)}
								{entry.sortCol && (
									<span class="text-xs text-text-secondary">
										<span class="text-text-muted">order:</span> <span class="font-mono">{entry.sortCol} {entry.sortDir}</span>
									</span>
								)}
							</div>
						</button>
