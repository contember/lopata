import { Breadcrumb, DeleteButton, EmptyState, PageHeader, RefreshButton, ServiceInfo, Table, TableLink } from '../components'
...
function CacheEntryList({ name }: { name: string }) {
	...
	return (
		<div class="p-8">
			...
			{!entries?.length ? <EmptyState message="No cache entries" /> : (
				<Table
