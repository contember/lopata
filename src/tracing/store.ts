...
export class TraceStore {
	...
	constructor(db?: Database) {
		...
		this.insertSpanStmt = this.db.prepare<
			void,
			[string, string, string | null, string, string, string, string | null, number, number | null, number | null, string, string | null]
		>(
	...
	getErrorsForTrace(
		traceId: string,
	): Array<{ id: string; timestamp: number; errorName: string; errorMessage: string; source: string | null; data: unknown }> {
