/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1cdda52a14f6400972953b4651da41c6)
// Runtime types generated with workerd@1.20260212.0 2026-02-12 nodejs_compat_v2
...
type LoopbackForExport<T extends (new(...args: any[]) => Rpc.EntrypointBranded) | ExportedHandler<any, any, any> | undefined = undefined> = T extends
	new(...args: any[]) => Rpc.WorkerEntrypointBranded ? LoopbackServiceStub<InstanceType<T>>
		...
		[K in keyof MainModule]:
			...
			& (K extends GlobalProp<'durableNamespaces', never>
				? MainModule[K] extends new(...args: any[]) => infer DoInstance
					? DoInstance extends Rpc.DurableObjectBranded ? DurableObjectNamespace<DoInstance> : DurableObjectNamespace<undefined>
